...
(() => {
    ...
    function registro(cedula, nombre, telefono) {
    ...
    function LugarDeNacimiento(nombre, cedula, nacionalidad) {
        let datosUsuarios = [];
    ...
    function ValoresPorDefecto(nombre = 'Alexandro') {
        if (nombre) {
